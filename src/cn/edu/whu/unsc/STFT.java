...
//        }
    ...
    public STFT() {
        init(1024, 128, 48000, 2, "Hanning");
    }

    public STFT(int fftLength, int hopLength, int sampleRate, int minFeedSize, String wndName) {
        init(fftLength, hopLength, sampleRate, minFeedSize, wndName);
    }
